...
<html>
    <head>
        ...
        <title>Universo Etnoeducación</title>
    </head>
    <body>
            ...
            <tbody>                
                    ...
                    <td>
                        <table>
                            <tr>                                
                                ...
                                <td id="diversidadColombia">
                                    <table>
                                        <tr>
                                            <td colspan="2" rowspan="2" class="elementoGrande" onclick="cargarScript('diversidadColombia');">
                                                <img onmouseover="clicksound.playclip();" src="Vista/imagenes/objetos/diversidadColombia.png" class="imagenUniversoGrande" />
                                                <label class="textoUniverso">Diversidad_en_Colombia</label>   
                                            </td>
                                        </tr>
                                    </table>
                                </td>  
                ...
                <tr>                
                    <td class="estructuraTD" id="fondoUniverso">                        
                        <img src="Vista/imagenes/universo/universo.png" class="universo">
                    </td>                    
                </tr>
